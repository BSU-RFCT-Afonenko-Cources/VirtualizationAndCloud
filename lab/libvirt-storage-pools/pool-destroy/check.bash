...
/usr/bin/sudo -n /usr/bin/virsh -c qemu:///system pool-info lab-pool >/home/ubuntu/pool-destroy/lab-pool-info-destroy 2>&1 || fail "lab-pool отсутствует после restart"
/usr/bin/grep -Eq '^(State|Состояние):[[:space:]]+(running|active|актив)' /home/ubuntu/pool-destroy/lab-pool-info-destroy || fail "lab-pool должен быть active после повторного запуска"
