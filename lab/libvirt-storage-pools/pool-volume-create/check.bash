...
/usr/bin/sudo -n /usr/bin/virsh -c qemu:///system vol-info --pool lab-pool lab-disk.qcow2 >/home/ubuntu/pool-volume-create/lab-disk-info 2>&1 || fail "volume lab-disk.qcow2 отсутствует"
PATH_NOW=$(/usr/bin/sudo -n /usr/bin/virsh -c qemu:///system vol-path --pool lab-pool lab-disk.qcow2)
case "$PATH_NOW" in /home/ubuntu/pool-volume-create/libvirt-lab-pool/lab-disk.qcow2) ;; *) fail "vol-path должен быть внутри /home/ubuntu/pool-volume-create/libvirt-lab-pool";; esac
