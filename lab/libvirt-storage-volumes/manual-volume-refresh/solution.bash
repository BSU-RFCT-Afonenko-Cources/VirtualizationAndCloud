...
if ! /usr/bin/sudo -n /usr/bin/virsh -c qemu:///system pool-info lab-pool >/dev/null 2>&1; then
  /usr/bin/sudo -n /usr/bin/install -d -m 0755 /home/ubuntu/manual-volume-refresh/libvirt-lab-pool
  /usr/bin/sudo -n /usr/bin/virsh -c qemu:///system pool-define-as lab-pool dir --target /home/ubuntu/manual-volume-refresh/libvirt-lab-pool >/dev/null
fi
/usr/bin/sudo -n /usr/bin/install -d -m 0755 /home/ubuntu/manual-volume-refresh/libvirt-lab-pool
...
/usr/bin/sudo -n /usr/bin/rm -f /home/ubuntu/manual-volume-refresh/libvirt-lab-pool/manual-volume.qcow2
/usr/bin/sudo -n /usr/bin/virsh -c qemu:///system vol-list lab-pool --details >"$DIR/vol-list-before-refresh.txt"
/usr/bin/sudo -n /usr/bin/qemu-img create -f qcow2 /home/ubuntu/manual-volume-refresh/libvirt-lab-pool/manual-volume.qcow2 32M >/dev/null
