...
for vol in lab-overlay.qcow2 lab-disk-clone.qcow2 lab-from-xml.qcow2 lab-sparse.qcow2 lab-raw.img lab-disk.qcow2 manual-volume.qcow2 generated-by-args.qcow2; do
  ...
  if /usr/bin/test -e "/home/ubuntu/vol-delete-cleanup/libvirt-lab-pool/$vol"; then fail "файл /home/ubuntu/vol-delete-cleanup/libvirt-lab-pool/$vol всё ещё существует"; fi
done
