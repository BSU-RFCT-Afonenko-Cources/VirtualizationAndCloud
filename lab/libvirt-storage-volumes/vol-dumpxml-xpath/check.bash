...
/usr/bin/grep -q '^/home/ubuntu/vol-dumpxml-xpath/libvirt-lab-pool/' "$DIR/xpath-path.txt" || fail "xpath-path.txt должен указывать на /home/ubuntu/vol-dumpxml-xpath/libvirt-lab-pool"
