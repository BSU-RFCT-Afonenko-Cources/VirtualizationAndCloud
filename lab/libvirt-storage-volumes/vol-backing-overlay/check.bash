...
/usr/bin/grep -q '/home/ubuntu/vol-backing-overlay/libvirt-lab-pool/lab-disk.qcow2' "$DIR/xpath-backing-path.txt" || fail "backing path должен указывать на lab-disk.qcow2"
