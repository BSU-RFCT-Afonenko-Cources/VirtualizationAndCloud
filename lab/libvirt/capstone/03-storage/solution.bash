...
D=/home/ubuntu/capstone/03-storage; ensure_dir "$D"; /usr/bin/sudo -n /usr/bin/install -d -m 0755 /home/ubuntu/capstone/03-storage/libvirt-capstone
if ! "${VIRSH[@]}" pool-info capstone-pool >/dev/null 2>&1; then "${VIRSH[@]}" pool-define-as capstone-pool dir --target /home/ubuntu/capstone/03-storage/libvirt-capstone >/dev/null; fi
