...
/usr/bin/grep -q "/home/ubuntu/backup-xml-full/libvirt-backups/lab-vm-vda-full.qcow2" "$DIR/full-backup.xml" || fail 'неверный target file'
...
/usr/bin/test -e /home/ubuntu/backup-xml-full/libvirt-backups/lab-vm-vda-full.qcow2 || /usr/bin/grep -qi 'unsupported\|job-active\|completed\|not supported\|failed\|error\|cannot' "$DIR/result.txt" "$DIR/backup-begin.txt" || fail 'нет backup-файла и нет корректной диагностики'
