...
/usr/bin/sudo -n /usr/bin/virsh -c qemu:///system dumpxml lab-vm --config >/home/ubuntu/dual-network-vm/lab-vm-config.xml
if ! /usr/bin/grep -q '52:54:00:aa:20:01' /home/ubuntu/dual-network-vm/lab-vm-config.xml; then
