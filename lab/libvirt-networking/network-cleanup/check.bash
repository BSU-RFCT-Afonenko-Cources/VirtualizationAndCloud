...
if /usr/bin/sudo -n /usr/bin/virsh -c qemu:///system dumpxml lab-vm --config >/home/ubuntu/network-cleanup/lab-vm-final.xml 2>/dev/null; then
  ! /usr/bin/grep -q '52:54:00:aa:10:01\|52:54:00:aa:20:01' /home/ubuntu/network-cleanup/lab-vm-final.xml || fail 'лабораторные MAC всё ещё присутствуют в XML lab-vm'
fi
