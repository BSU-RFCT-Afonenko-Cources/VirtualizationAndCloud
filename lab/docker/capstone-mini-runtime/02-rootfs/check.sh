...
require_dir "$ROOTFS"
for path in proc sys/fs/cgroup run/mini-runtime home/ubuntu/mini-runtime; do require_dir "$ROOTFS/$path"; done
require_file "$ROOTFS/home/ubuntu/mini-runtime/mini-runtime-api.py"
...
[ -x "$ROOTFS/home/ubuntu/mini-runtime/mini-runtime-api.py" ] || fail 'API is not executable'
