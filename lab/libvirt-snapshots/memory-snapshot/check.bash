...
/usr/bin/grep -q '/home/ubuntu/memory-snapshot/libvirt-snapshots/lab-mem-001.memory' "$DIR/lab-mem-001.xml" || fail 'XML не содержит memory file'
/usr/bin/grep -q '/home/ubuntu/memory-snapshot/libvirt-snapshots/lab-mem-001.qcow2' "$DIR/lab-mem-001.xml" || fail 'XML не содержит external disk file'
if /usr/bin/test -s "$DIR/memory-success.txt"; then
  ...
  /usr/bin/test -s /home/ubuntu/memory-snapshot/libvirt-snapshots/lab-mem-001.memory || fail 'нет external memory file'
  exit 0
fi
